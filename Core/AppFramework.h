...
void OnResizeFrame(GLFWwindow * window, int w, int h) {
    ...
    Falcon::RenderEngine::Instance()->Resize(w, h);
}
...
public:
    ...
    int Run() {
        ...
        //Falcon::RenderEngine::Initialize(hMainWnd, width, height);
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            Falcon::RenderEngine::Instance()->Present();
        }

        //Falcon::RenderEngine::FreeResources();
        glfwTerminate();
