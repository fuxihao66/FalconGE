...
void DX12RenderBackend::InitializePipeline() {
	...
	mRtvDescriptorSize = _d3dDevice->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_RTV);
	mDsvDescriptorSize = _d3dDevice->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_DSV);
	mCbvSrvUavDescriptorSize = _d3dDevice->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
...
void DX12RenderBackend::CreateRtvAndDsvDescriptorHeaps()
{
...
void DX12RenderBackend::CreateCommandObjects()
{
...
void DX12RenderBackend::CreateSwapChain()
{
...
void DX12RenderBackend::FlushCommandQueue()
{
